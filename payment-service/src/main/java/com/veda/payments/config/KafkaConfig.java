...
public class KafkaConfig {
    private Map<String, Object> baseProducerProperties(String bootstrapServers) {
    ...
    ProducerFactory<String, PaymentCreatedEvent> paymentProducerFactory(
        ...
        Map<String, Object> props = baseProducerProperties(bootstrapServers);
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
        return new DefaultKafkaProducerFactory<>(props);
    }

    @Bean
    KafkaTemplate<String, PaymentCreatedEvent> paymentKafkaTemplate(
